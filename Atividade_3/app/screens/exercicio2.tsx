...
export default function Exercicio2(){
    ...
    const abrirDiscador = async () => {
        const numeroTelefone = "11999887766"; // Número de exemplo
        ...
        try {
            ...
            if (supported) {
                // Abre a interface de discagem com o número preenchido
    ...
    return(
        <SafeAreaView style={styles.container}>
            <View style={styles.content}>
                ...
                <Text style={styles.phoneNumber}>📞 (11) 99988-7766</Text>
